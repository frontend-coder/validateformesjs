...
function scripts() {
  return src([
    ...
    'app/libs/plagins/just-validate.min.js',
    'app/libs/plagins/inputmask.min.js',
    'app/libs/plagins/wavify.js',
    'app/libs/plagins/jquery.ihavecookies.min.js',
    'app/libs/common.js',
  ])
    .pipe(strip())
    .pipe(rigger())
...
function images() {
  return src('app/img/**/*').pipe(newer('dist/img/')).pipe(imagemin()).pipe(dest('dest/img/'));
}
...
exports.build = series(cleandest, styles, scripts, buildcopy);
